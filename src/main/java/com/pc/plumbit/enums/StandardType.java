...
public enum StandardType {
    ...
    WATER_DEMAND_COMMERTIAL("WATER DEMAND Commertial"),
    SOLID_WASTE_KG_PERSON_DAY_COMMERTIAL("SOLID WASTE Kg/person/day Commertial"),
    GAS_BANK_COMMERTIAL("GAS_BANK Commertial"),
    SOLAR_COMMERTIAL("SOLAR Commertial"),
    SOLID_WASTE_DRY_GARBAGE_COMMERTIAL("SOLID WASTE DRY GARBAGE Commertial"),
    SOLID_WASTE_WET_GARBAGE_COMMERTIAL("SOLID WASTE WET GARBAGE Commertial"),
